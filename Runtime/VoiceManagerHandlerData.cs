...
public static class VoiceManagerHandlerData
{
    ...
    public static event Action<int, bool> OnSetUserAudioSubscription;
    ...
    public static void NotifySetUserAudioSubscription(int clientId, bool subscribe) => OnSetUserAudioSubscription?.Invoke(clientId, subscribe);
